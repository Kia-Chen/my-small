  ...
  <div>
    ...
    <div class="content">
      <table class="table-goods" v-if="cart.length">
        ...
        <tr v-for="(item, index) in cart" :key="index">
          <td class="col01 one-line" :title="item.text">
            <Checkbox class="checkbox" v-model="checkedArray[index]" @change="onCheckChanged">
            </Checkbox>&nbsp;&nbsp;
          ...
          <td class="col03">
            <input class="ipt-quantity" type="number"
              v-model="item.quantity" @change="toggleQuantity" min=1>
          </td>
      ...
      <div class="banner-pay">
        ...
        <!-- <span class="btn-del" @click="delAll">删&nbsp;&nbsp;除</span> -->
...
<style scoped>
  ...
  .table-goods>tbody>tr:hover {
    background-color: rgba(243, 199, 221, 0.137);
  }
